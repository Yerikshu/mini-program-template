var fakeWindow = {};var fakeDocument = {};(function(window, document) {})(fakeWindow, fakeDocument);require('common/vendors~miniprogram-app~page1~page2~page3~page4.js')(fakeWindow, fakeDocument);require('common/miniprogram-app.js')(fakeWindow, fakeDocument);var appConfig = fakeWindow.appOptions || {};
