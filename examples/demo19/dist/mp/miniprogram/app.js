var fakeWindow = {};var fakeDocument = {};(function(window, document) {})(fakeWindow, fakeDocument);require('common/miniprogram-app.js')(fakeWindow, fakeDocument);var appConfig = fakeWindow.appOptions || {};
